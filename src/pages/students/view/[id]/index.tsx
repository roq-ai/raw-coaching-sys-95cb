...
import { EnrollmentListPage } from 'pages/enrollments';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="School Name" text={data?.school_name} />

                <FormListItem label="Preferred Subjects" text={data?.preferred_subjects} />
