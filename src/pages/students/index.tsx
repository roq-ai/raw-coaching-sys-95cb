...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['user', 'enrollment.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['school_name.contains', 'preferred_subjects.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'school_name', header: 'School Name', accessorKey: 'school_name' },
    { id: 'preferred_subjects', header: 'Preferred Subjects', accessorKey: 'preferred_subjects' },
    ...
    hasAccess('enrollment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.enrollment,
        }
      : null,
