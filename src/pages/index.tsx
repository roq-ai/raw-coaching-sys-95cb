...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`RAW Coaching System`}</title>

        <meta
          name="description"
          content="Unleash your potential with RAW Coaching System - Your gateway to a diverse range of online classes, flexible scheduling, and seamless enrollment. Learn, grow and excel with us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBlZHVjYXRpb258ZW58MHx8fHwxNjkzODkzMjkxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@cwmonty?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Chris Montgomery`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your potential with RAW Coaching System - Your gateway to a diverse range of online classes, flexible scheduling, and seamless enrollment. Learn, grow and excel with us.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Institute Owner" type="institute-owner" abilities={appConfig.ownerAbilities} />

                <Card userTypeName="Student" type="student" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
